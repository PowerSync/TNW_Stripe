...
use TNW\Stripe\Gateway\Http\Client\TransactionCapture;
...
class TransactionCaptureTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->model = new TransactionCapture($this->criticalLogger, $this->logger, $adapterFactory);
    }
    ...
    public function testPlaceRequestException()
    {
        ...
        $this->adapter->method('capture')
            ->with('transaction-id-test-data-value', 'amount-test-data-value')
    ...
    private function getTransferData()
    {
        return [
            ...
            'transaction_id' => 'transaction-id-test-data-value',
            'amount' => 'amount-test-data-value',
        ];
    }
}
