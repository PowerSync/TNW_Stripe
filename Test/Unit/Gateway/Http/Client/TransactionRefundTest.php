...
use TNW\Stripe\Gateway\Http\Client\TransactionRefund;
...
class TransactionRefundTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->model = new TransactionRefund($this->criticalLogger, $this->logger, $adapterFactory);
    }
