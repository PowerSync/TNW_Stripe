...
/**
 * Test TransactionCustomer
 */
class TransactionCustomerTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    protected function setUp()
    {
        ...
        $this->model = new TransactionCustomer($this->criticalLogger, $this->logger, $adapterFactory);
    }
    ...
    public function testPlaceRequestException()
    {
        $this->logger->method('debug')
            ->with([
                ...
                'client' => TransactionCustomer::class,
                'response' => []
            ]);
